...
type Schema struct {
	...
	Type                 *Schema_Type `protobuf:"varint,4,req,name=type,enum=pulsarnetdata.proto.Schema_Type" json:"type,omitempty"`
...
type MessageMetadata struct {
	...
	Compression      *CompressionType `protobuf:"varint,8,opt,name=compression,enum=pulsarnetdata.proto.CompressionType,def=0" json:"compression,omitempty"`
...
type CommandConnect struct {
	...
	AuthMethod      *AuthMethod `protobuf:"varint,2,opt,name=auth_method,json=authMethod,enum=pulsarnetdata.proto.AuthMethod" json:"auth_method,omitempty"`
...
type KeySharedMeta struct {
	KeySharedMode           *KeySharedMode `protobuf:"varint,1,req,name=keySharedMode,enum=pulsarnetdata.proto.KeySharedMode" json:"keySharedMode,omitempty"`
...
type CommandSubscribe struct {
	...
	SubType       *CommandSubscribe_SubType `protobuf:"varint,3,req,name=subType,enum=pulsarnetdata.proto.CommandSubscribe_SubType" json:"subType,omitempty"`
	...
	// or not -- earliest
	InitialPosition *CommandSubscribe_InitialPosition `protobuf:"varint,13,opt,name=initialPosition,enum=pulsarnetdata.proto.CommandSubscribe_InitialPosition,def=0" json:"initialPosition,omitempty"`
...
type CommandPartitionedTopicMetadataResponse struct {
	...
	RequestId            *uint64                                             `protobuf:"varint,2,req,name=request_id,json=requestId" json:"request_id,omitempty"`
	Response             *CommandPartitionedTopicMetadataResponse_LookupType `protobuf:"varint,3,opt,name=response,enum=pulsarnetdata.proto.CommandPartitionedTopicMetadataResponse_LookupType" json:"response,omitempty"`
	Error                *ServerError                                        `protobuf:"varint,4,opt,name=error,enum=pulsarnetdata.proto.ServerError" json:"error,omitempty"`
...
type CommandLookupTopicResponse struct {
	...
	Response            *CommandLookupTopicResponse_LookupType `protobuf:"varint,3,opt,name=response,enum=pulsarnetdata.proto.CommandLookupTopicResponse_LookupType" json:"response,omitempty"`
	...
	Error               *ServerError                           `protobuf:"varint,6,opt,name=error,enum=pulsarnetdata.proto.ServerError" json:"error,omitempty"`
...
type CommandSendError struct {
	ProducerId           *uint64      `protobuf:"varint,1,req,name=producer_id,json=producerId" json:"producer_id,omitempty"`
	SequenceId           *uint64      `protobuf:"varint,2,req,name=sequence_id,json=sequenceId" json:"sequence_id,omitempty"`
	Error                *ServerError `protobuf:"varint,3,req,name=error,enum=pulsarnetdata.proto.ServerError" json:"error,omitempty"`
...
type CommandAck struct {
	ConsumerId *uint64             `protobuf:"varint,1,req,name=consumer_id,json=consumerId" json:"consumer_id,omitempty"`
	AckType    *CommandAck_AckType `protobuf:"varint,2,req,name=ack_type,json=ackType,enum=pulsarnetdata.proto.CommandAck_AckType" json:"ack_type,omitempty"`
	// In case of individual acks, the client can pass a list of message ids
	MessageId            []*MessageIdData            `protobuf:"bytes,3,rep,name=message_id,json=messageId" json:"message_id,omitempty"`
	ValidationError      *CommandAck_ValidationError `protobuf:"varint,4,opt,name=validation_error,json=validationError,enum=pulsarnetdata.proto.CommandAck_ValidationError" json:"validation_error,omitempty"`
...
type CommandError struct {
	RequestId            *uint64      `protobuf:"varint,1,req,name=request_id,json=requestId" json:"request_id,omitempty"`
	Error                *ServerError `protobuf:"varint,2,req,name=error,enum=pulsarnetdata.proto.ServerError" json:"error,omitempty"`
...
type CommandConsumerStatsResponse struct {
	RequestId    *uint64      `protobuf:"varint,1,req,name=request_id,json=requestId" json:"request_id,omitempty"`
	ErrorCode    *ServerError `protobuf:"varint,2,opt,name=error_code,json=errorCode,enum=pulsarnetdata.proto.ServerError" json:"error_code,omitempty"`
...
type CommandGetTopicsOfNamespace struct {
	...
	Mode                 *CommandGetTopicsOfNamespace_Mode `protobuf:"varint,3,opt,name=mode,enum=pulsarnetdata.proto.CommandGetTopicsOfNamespace_Mode,def=0" json:"mode,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                          `json:"-"`
	XXX_unrecognized     []byte                            `json:"-"`
	XXX_sizecache        int32                             `json:"-"`
}
...
type CommandEndTxn struct {
	...
	TxnidLeastBits       *uint64    `protobuf:"varint,2,opt,name=txnid_least_bits,json=txnidLeastBits,def=0" json:"txnid_least_bits,omitempty"`
	TxnidMostBits        *uint64    `protobuf:"varint,3,opt,name=txnid_most_bits,json=txnidMostBits,def=0" json:"txnid_most_bits,omitempty"`
	TxnAction            *TxnAction `protobuf:"varint,4,opt,name=txn_action,json=txnAction,enum=pulsarnetdata.proto.TxnAction" json:"txn_action,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
type CommandEndTxnOnPartition struct {
	...
	TxnAction            *TxnAction `protobuf:"varint,5,opt,name=txn_action,json=txnAction,enum=pulsarnetdata.proto.TxnAction" json:"txn_action,omitempty"`
	XXX_NoUnkeyedLiteral struct{}   `json:"-"`
	XXX_unrecognized     []byte     `json:"-"`
	XXX_sizecache        int32      `json:"-"`
}
...
type BaseCommand struct {
	Type                            *BaseCommand_Type                        `protobuf:"varint,1,req,name=type,enum=pulsarnetdata.proto.BaseCommand_Type" json:"type,omitempty"`
...
func init() {
	proto.RegisterEnum("pulsarnetdata.proto.CompressionType", CompressionType_name, CompressionType_value)
	proto.RegisterEnum("pulsarnetdata.proto.ServerError", ServerError_name, ServerError_value)
	proto.RegisterEnum("pulsarnetdata.proto.AuthMethod", AuthMethod_name, AuthMethod_value)
	proto.RegisterEnum("pulsarnetdata.proto.ProtocolVersion", ProtocolVersion_name, ProtocolVersion_value)
	proto.RegisterEnum("pulsarnetdata.proto.KeySharedMode", KeySharedMode_name, KeySharedMode_value)
	proto.RegisterEnum("pulsarnetdata.proto.TxnAction", TxnAction_name, TxnAction_value)
	proto.RegisterEnum("pulsarnetdata.proto.Schema_Type", Schema_Type_name, Schema_Type_value)
	proto.RegisterEnum("pulsarnetdata.proto.CommandSubscribe_SubType", CommandSubscribe_SubType_name, CommandSubscribe_SubType_value)
	proto.RegisterEnum("pulsarnetdata.proto.CommandSubscribe_InitialPosition", CommandSubscribe_InitialPosition_name, CommandSubscribe_InitialPosition_value)
	proto.RegisterEnum("pulsarnetdata.proto.CommandPartitionedTopicMetadataResponse_LookupType", CommandPartitionedTopicMetadataResponse_LookupType_name, CommandPartitionedTopicMetadataResponse_LookupType_value)
	proto.RegisterEnum("pulsarnetdata.proto.CommandLookupTopicResponse_LookupType", CommandLookupTopicResponse_LookupType_name, CommandLookupTopicResponse_LookupType_value)
	proto.RegisterEnum("pulsarnetdata.proto.CommandAck_AckType", CommandAck_AckType_name, CommandAck_AckType_value)
	proto.RegisterEnum("pulsarnetdata.proto.CommandAck_ValidationError", CommandAck_ValidationError_name, CommandAck_ValidationError_value)
	proto.RegisterEnum("pulsarnetdata.proto.CommandGetTopicsOfNamespace_Mode", CommandGetTopicsOfNamespace_Mode_name, CommandGetTopicsOfNamespace_Mode_value)
	proto.RegisterEnum("pulsarnetdata.proto.BaseCommand_Type", BaseCommand_Type_name, BaseCommand_Type_value)
	proto.RegisterType((*Schema)(nil), "pulsarnetdata.proto.Schema")
	proto.RegisterType((*MessageIdData)(nil), "pulsarnetdata.proto.MessageIdData")
	proto.RegisterType((*KeyValue)(nil), "pulsarnetdata.proto.KeyValue")
	proto.RegisterType((*KeyLongValue)(nil), "pulsarnetdata.proto.KeyLongValue")
	proto.RegisterType((*IntRange)(nil), "pulsarnetdata.proto.IntRange")
	proto.RegisterType((*EncryptionKeys)(nil), "pulsarnetdata.proto.EncryptionKeys")
	proto.RegisterType((*MessageMetadata)(nil), "pulsarnetdata.proto.MessageMetadata")
	proto.RegisterType((*SingleMessageMetadata)(nil), "pulsarnetdata.proto.SingleMessageMetadata")
	proto.RegisterType((*CommandConnect)(nil), "pulsarnetdata.proto.CommandConnect")
	proto.RegisterType((*FeatureFlags)(nil), "pulsarnetdata.proto.FeatureFlags")
	proto.RegisterType((*CommandConnected)(nil), "pulsarnetdata.proto.CommandConnected")
	proto.RegisterType((*CommandAuthResponse)(nil), "pulsarnetdata.proto.CommandAuthResponse")
	proto.RegisterType((*CommandAuthChallenge)(nil), "pulsarnetdata.proto.CommandAuthChallenge")
	proto.RegisterType((*AuthData)(nil), "pulsarnetdata.proto.AuthData")
	proto.RegisterType((*KeySharedMeta)(nil), "pulsarnetdata.proto.KeySharedMeta")
	proto.RegisterType((*CommandSubscribe)(nil), "pulsarnetdata.proto.CommandSubscribe")
	proto.RegisterType((*CommandPartitionedTopicMetadata)(nil), "pulsarnetdata.proto.CommandPartitionedTopicMetadata")
	proto.RegisterType((*CommandPartitionedTopicMetadataResponse)(nil), "pulsarnetdata.proto.CommandPartitionedTopicMetadataResponse")
	proto.RegisterType((*CommandLookupTopic)(nil), "pulsarnetdata.proto.CommandLookupTopic")
	proto.RegisterType((*CommandLookupTopicResponse)(nil), "pulsarnetdata.proto.CommandLookupTopicResponse")
	proto.RegisterType((*CommandProducer)(nil), "pulsarnetdata.proto.CommandProducer")
	proto.RegisterType((*CommandSend)(nil), "pulsarnetdata.proto.CommandSend")
	proto.RegisterType((*CommandSendReceipt)(nil), "pulsarnetdata.proto.CommandSendReceipt")
	proto.RegisterType((*CommandSendError)(nil), "pulsarnetdata.proto.CommandSendError")
	proto.RegisterType((*CommandMessage)(nil), "pulsarnetdata.proto.CommandMessage")
	proto.RegisterType((*CommandAck)(nil), "pulsarnetdata.proto.CommandAck")
	proto.RegisterType((*CommandAckResponse)(nil), "pulsarnetdata.proto.CommandAckResponse")
	proto.RegisterType((*CommandActiveConsumerChange)(nil), "pulsarnetdata.proto.CommandActiveConsumerChange")
	proto.RegisterType((*CommandFlow)(nil), "pulsarnetdata.proto.CommandFlow")
	proto.RegisterType((*CommandUnsubscribe)(nil), "pulsarnetdata.proto.CommandUnsubscribe")
	proto.RegisterType((*CommandSeek)(nil), "pulsarnetdata.proto.CommandSeek")
	proto.RegisterType((*CommandReachedEndOfTopic)(nil), "pulsarnetdata.proto.CommandReachedEndOfTopic")
	proto.RegisterType((*CommandCloseProducer)(nil), "pulsarnetdata.proto.CommandCloseProducer")
	proto.RegisterType((*CommandCloseConsumer)(nil), "pulsarnetdata.proto.CommandCloseConsumer")
	proto.RegisterType((*CommandRedeliverUnacknowledgedMessages)(nil), "pulsarnetdata.proto.CommandRedeliverUnacknowledgedMessages")
	proto.RegisterType((*CommandSuccess)(nil), "pulsarnetdata.proto.CommandSuccess")
	proto.RegisterType((*CommandProducerSuccess)(nil), "pulsarnetdata.proto.CommandProducerSuccess")
	proto.RegisterType((*CommandError)(nil), "pulsarnetdata.proto.CommandError")
	proto.RegisterType((*CommandPing)(nil), "pulsarnetdata.proto.CommandPing")
	proto.RegisterType((*CommandPong)(nil), "pulsarnetdata.proto.CommandPong")
	proto.RegisterType((*CommandConsumerStats)(nil), "pulsarnetdata.proto.CommandConsumerStats")
	proto.RegisterType((*CommandConsumerStatsResponse)(nil), "pulsarnetdata.proto.CommandConsumerStatsResponse")
	proto.RegisterType((*CommandGetLastMessageId)(nil), "pulsarnetdata.proto.CommandGetLastMessageId")
	proto.RegisterType((*CommandGetLastMessageIdResponse)(nil), "pulsarnetdata.proto.CommandGetLastMessageIdResponse")
	proto.RegisterType((*CommandGetTopicsOfNamespace)(nil), "pulsarnetdata.proto.CommandGetTopicsOfNamespace")
	proto.RegisterType((*CommandGetTopicsOfNamespaceResponse)(nil), "pulsarnetdata.proto.CommandGetTopicsOfNamespaceResponse")
	proto.RegisterType((*CommandGetSchema)(nil), "pulsarnetdata.proto.CommandGetSchema")
	proto.RegisterType((*CommandGetSchemaResponse)(nil), "pulsarnetdata.proto.CommandGetSchemaResponse")
	proto.RegisterType((*CommandGetOrCreateSchema)(nil), "pulsarnetdata.proto.CommandGetOrCreateSchema")
	proto.RegisterType((*CommandGetOrCreateSchemaResponse)(nil), "pulsarnetdata.proto.CommandGetOrCreateSchemaResponse")
	proto.RegisterType((*CommandNewTxn)(nil), "pulsarnetdata.proto.CommandNewTxn")
	proto.RegisterType((*CommandNewTxnResponse)(nil), "pulsarnetdata.proto.CommandNewTxnResponse")
	proto.RegisterType((*CommandAddPartitionToTxn)(nil), "pulsarnetdata.proto.CommandAddPartitionToTxn")
	proto.RegisterType((*CommandAddPartitionToTxnResponse)(nil), "pulsarnetdata.proto.CommandAddPartitionToTxnResponse")
	proto.RegisterType((*Subscription)(nil), "pulsarnetdata.proto.Subscription")
	proto.RegisterType((*CommandAddSubscriptionToTxn)(nil), "pulsarnetdata.proto.CommandAddSubscriptionToTxn")
	proto.RegisterType((*CommandAddSubscriptionToTxnResponse)(nil), "pulsarnetdata.proto.CommandAddSubscriptionToTxnResponse")
	proto.RegisterType((*CommandEndTxn)(nil), "pulsarnetdata.proto.CommandEndTxn")
	proto.RegisterType((*CommandEndTxnResponse)(nil), "pulsarnetdata.proto.CommandEndTxnResponse")
	proto.RegisterType((*CommandEndTxnOnPartition)(nil), "pulsarnetdata.proto.CommandEndTxnOnPartition")
	proto.RegisterType((*CommandEndTxnOnPartitionResponse)(nil), "pulsarnetdata.proto.CommandEndTxnOnPartitionResponse")
	proto.RegisterType((*CommandEndTxnOnSubscription)(nil), "pulsarnetdata.proto.CommandEndTxnOnSubscription")
	proto.RegisterType((*CommandEndTxnOnSubscriptionResponse)(nil), "pulsarnetdata.proto.CommandEndTxnOnSubscriptionResponse")
	proto.RegisterType((*BaseCommand)(nil), "pulsarnetdata.proto.BaseCommand")
}
...
var fileDescriptor_39529ba7ad9caeb8 = []byte{
	...
	,
}
